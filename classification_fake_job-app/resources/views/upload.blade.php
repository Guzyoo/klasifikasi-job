                ...
                <div class="space-y-8">
                    ...
                    <div>
                        ...
                        <div id="dropzone" class="upload-area group" onclick="document.getElementById('job_file').click()">
                            <input type="file" name="job_file" id="job_file" class="hidden" accept="image/jpeg,image/png,video/mp4" onchange="previewFile()">
                            ...
                            <div id="placeholder-content">
                                ...
                                <p class="text-xs text-slate-500 mt-1">Mendukung Gambar (PNG, JPG) atau Video (MP4), maksimal 50 MB</p>
                            </div>
